 ...
 void frontscreen(void)
{
	...
	output(40,90,"Kruthika R and Rakshitha G ");
	...
	glColor3f(1,1,0);
	output(70,40,"Mr. SHANKAR R");
	glColor3f(1,1,0);
	output(40,30,"");
	glColor3f(1,1,0);
	drawstring(72,30,"",GLUT_BITMAP_HELVETICA_12);

	output(70,30,"Assistant Professor");
	output(70,20,"CSE ,BMSIT&M");
	glFlush();
 ...
 void winscreen()
 {
	...
	output(15,100,"YOU HAVE SUCCEEDED IN COMPLETING THE MAZE");
...
glClear(GL_COLOR_BUFFER_BIT);
glColor3f(1.0,0.5,0.0);
output(25,140,"WELCOME TO THE MAZE GAME");
...
void instructions()
{
  ...
  output(-20,80,"* BLUE COLOURED POINT INDICATE THE POINT FROM WHERE YOU HAVE TO START");
  output(-20,60,"* GREEN COLOURED POINT INDICATE THE POINT WHERE YOU HAVE TO REACH");
  output(-20,40,"* YOU WILL HAVE TO HURRY AS YOU HAVE LIMITED TIME OF 60 SEC");
...
frontscreen();
    ...
    else if(df==1)
     {
		...
		drawstring(200,150,"HURRY UP",GLUT_BITMAP_HELVETICA_18);
		glColor3f(1,0,1);
